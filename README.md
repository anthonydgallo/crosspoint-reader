...
- **X4 apps**: an SD-card Apps menu with bundled Rosary, art, calculator, flashcards, Minesweeper, quotes,
  book highlights, text tools, and PNG/JPEG viewing. Download `apps.zip` from this fork's release, extract it,
  and copy the top-level `apps/` directory to the SD-card root. Long-press Confirm in the Apps menu to delete an app.
...
1. Connect your device to your computer via USB-C and wake/unlock the device
2. Download `firmware.bin` from [this fork's releases](https://github.com/anthonydgallo/crosspoint-reader/releases), a local build, or a continuous integration artifact.
