...
inline std::vector<SettingInfo> getSettingsList() {
  return {
      ...
      SettingInfo::Enum(StrId::STR_UI_THEME, &CrossPointSettings::uiTheme,
                        {StrId::STR_THEME_CLASSIC, StrId::STR_THEME_LYRA, StrId::STR_THEME_LYRA_EXTENDED, StrId::STR_THEME_FILE_BROWSER}, "uiTheme",
                        StrId::STR_CAT_DISPLAY),
      ...
      SettingInfo::Toggle(StrId::STR_HIDE_OPDS_BROWSER, &CrossPointSettings::hideOpdsBrowser, "hideOpdsBrowser",
